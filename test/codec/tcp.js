...
describe('tcp', () => {
  ...
  describe('pushBlock', () => {
    it('should parse a push block request', () => {
    ...
    it('should parse a push block response', () => {
      expect(() => tcp.pushBlock.response(undefined)).to.throwException()
    })
  })

  describe('pullBlock', () => {
    it('should parse a pull block request', () => {
    ...
    it('should parse a pull block response', () => {
      let buffer = Buffer.from('', 'hex')
  ...
  describe('pullTransactions', () => {
    ...
    it('should parse a pull transactions response', () => {
      let buffer = Buffer.from('', 'hex')
  ...
  describe('subCacheMerkleRoots', () => {
    it('should parse a sub cache merkle roots request', () => {
    ...
    it('should parse a sub cache merkle roots response', () => {
  ...
  describe('accountStatePath', () => {
    it('should parse an account state path request', () => {
    ...
    it('should parse an account state path response', () => {
  ...
  describe('hashLockStatePath', () => {
    it('should parse an hash lock state path request', () => {
    ...
    it('should parse a hash lock state path response', () => {
  ...
  describe('secretLockStatePath', () => {
    it('should parse an secret lock state path request', () => {
      let buffer = Buffer.from('A5F82EC8EBB341427B6785C8111906CD0DF18838FB11B51CE0E18B5E79DFF630', 'hex')
    ...
    it('should parse a secret lock state path response', () => {
      let buffer = Buffer.from('00000000', 'hex')
      expect(tcp.secretLockStatePath.response(buffer)).to.eql([
        {
          path: '',
  ...
  describe('metadataStatePath', () => {
    it('should parse an metadata state path request', () => {
    ...
    it('should parse a metadata state path response', () => {
  ...
  describe('mosaicStatePath', () => {
    it('should parse an mosaic state path request', () => {
    ...
    it('should parse a mosaic state path response', () => {
  ...
  describe('multisigStatePath', () => {
    it('should parse an multisig state path request', () => {
    ...
    it('should parse a multisig state path response', () => {
  ...
  describe('namespaceStatePath', () => {
    it('should parse an namespace state path request', () => {
    ...
    it('should parse a namespace state path response', () => {
  ...
  describe('accountRestrictionsStatePath', () => {
    it('should parse an account restriction path request', () => {
      let buffer = Buffer.from('984811DA06C4DDEC900173CF63375D9BF53D1594AF00E6F650', 'hex')
    ...
    it('should parse an account restriction path response', () => {
  ...
  describe('mosaicRestrictionsStatePath', () => {
    it('should parse an mosaic restriction path request', () => {
    ...
    it('should parse an mosaic restriction path response', () => {
